...
public class Tipo_OcorrenciaBean
{
  ...
  private String DM_Envia_EDI;
  private String DM_Status;
  private String DM_Aplicacao;

	public Tipo_OcorrenciaBean() {}
	...
	public String getDM_Envia_EDI() {
		return DM_Envia_EDI;
	}
	public void setDM_Envia_EDI(String envia_EDI) {
		DM_Envia_EDI = envia_EDI;
	}
	...
	public int insert() throws Exception
	{
		...
		try
		{
			...
			ResultSet cursor = stmt.executeQuery(
				"SELECT MAX(OID_Tipo_Ocorrencia) FROM Tipos_Ocorrencias");
		...
		buff.append("INSERT INTO Tipos_Ocorrencias (OID_Tipo_Ocorrencia, CD_Tipo_Ocorrencia, NM_Tipo_Ocorrencia, Dt_Stamp, Usuario_Stamp, Dm_Stamp, DM_Tipo, DM_Acesso, DM_Avaria, DM_Envia_EDI, DM_Status, DM_Aplicacao) ");
		buff.append("VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
		/*
		...
		try
		{
			...
			pstmt.setString(10, getDM_Envia_EDI());
			pstmt.setString(11, getDM_Status());
			pstmt.setString(12, getDM_Aplicacao());
	...
	public void update() throws Exception
	{
		 ...
		 */
		StringBuffer buff = new StringBuffer();
		buff.append("UPDATE Tipos_Ocorrencias SET NM_Tipo_Ocorrencia=?, Dt_Stamp=?, Usuario_Stamp=?, Dm_Stamp=?, DM_Tipo=?, DM_Acesso=?, DM_Avaria=?, DM_Status=?, DM_Aplicacao=?, DM_Envia_EDI=? ");
	...
	public void delete() throws Exception
	{
		 ...
		 */
		StringBuffer buff = new StringBuffer();
		buff.append("DELETE FROM Tipos_Ocorrencias ");
		buff.append("WHERE OID_Tipo_Ocorrencia=?");
		/*
		 * Define os dados do SQL
		 * e executa o insert no banco.
	...
	public static final Tipo_OcorrenciaBean getByOID(int oid)
		throws Exception
	{
		/*
		 * Abre a conexão com o banco
		...
		Tipo_OcorrenciaBean p = new Tipo_OcorrenciaBean();
		try
		{
			StringBuffer buff = new StringBuffer();
			...
			buff.append("	DM_Envia_EDI, ");
			buff.append("	DM_Status, ");
			buff.append("	DM_Aplicacao ");
			buff.append("FROM Tipos_Ocorrencias ");
			buff.append("WHERE OID_Tipo_Ocorrencia= ");
			buff.append(oid);
			...
			while (cursor.next())
			{
				...
				p.setDM_Envia_EDI(cursor.getString(7));
				p.setDM_Status(cursor.getString(8));
				p.setDM_Aplicacao(cursor.getString(9));
			}
			cursor.close();
			stmt.close();
			conn.close();
	...
	public static final Tipo_OcorrenciaBean getByCD_Tipo_Ocorrencia(String CD_Tipo_Ocorrencia)
		throws Exception
	{
		/*
		 * Abre a conexão com o banco
	...
	public static final List getByNM_Tipo_Ocorrencia(String NM_Tipo_Ocorrencia)
		throws Exception
	{
		/*
		 * Abre a conexão com o banco
		...
		List Tipos_Ocorrencias_Lista = new ArrayList();
		try
		{
			StringBuffer buff = new StringBuffer();
			buff.append("SELECT OID_Tipo_Ocorrencia, ");
		...
		return Tipos_Ocorrencias_Lista;
	}


	public static final List getByDM_Aplicacao(String DM_Aplicacao)
		throws Exception
	{
		/*
		 * Abre a conexão com o banco
