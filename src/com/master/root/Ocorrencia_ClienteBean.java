...
public class Ocorrencia_ClienteBean {

    private String NM_Contato;
    private String DT_Ocorrencia_Cliente;
    private String HR_Ocorrencia_Cliente;
    ...
    public Ocorrencia_ClienteBean() {
        NM_Contato = " ";
        HR_Ocorrencia_Cliente = " ";
        TX_Descricao = " ";
    }
    ...
    public String getDT_Ocorrencia_Cliente() {
        FormataDataBean DataFormatada = new FormataDataBean();
        DataFormatada.setDT_FormataData(DT_Ocorrencia_Cliente);
        DT_Ocorrencia_Cliente = DataFormatada.getDT_FormataData();

        return DT_Ocorrencia_Cliente;
    }

    public void setDT_Ocorrencia_Cliente(String DT_Ocorrencia_Cliente) {
        this.DT_Ocorrencia_Cliente = DT_Ocorrencia_Cliente;
    }

    public String getHR_Ocorrencia_Cliente() {
        return HR_Ocorrencia_Cliente;
    }

    public void setHR_Ocorrencia_Cliente(String HR_Ocorrencia_Cliente) {
        this.HR_Ocorrencia_Cliente = HR_Ocorrencia_Cliente;
    }
    ...
    public void insert() throws Exception {
        ...
        try {
            ...
            ResultSet cursor = stmt.executeQuery("SELECT MAX(OID_Ocorrencia_Cliente) FROM Ocorrencias_Clientes");
        ...
        buff.append("INSERT INTO Ocorrencias_Clientes (OID_Ocorrencia_Cliente, OID_Tipo_Ocorrencia, OID_Pessoa,  NM_Contato, DT_Ocorrencia_Cliente, HR_Ocorrencia_Cliente, DM_Gera_Pendencia, DT_Final_Pendencia, TX_Descricao) ");
        buff.append("VALUES (?,?,?,?,?,?,?,?,?)");
        try {
            ...
            pstmt.setString(5, this.DT_Ocorrencia_Cliente);
            pstmt.setString(6, getHR_Ocorrencia_Cliente());
    ...
    public void update() throws Exception {
        ...
        StringBuffer buff = new StringBuffer();
        buff.append("UPDATE Ocorrencias_Clientes SET OID_Tipo_Ocorrencia=?, NM_Contato=?, DM_Gera_Pendencia=?, DT_Final_Pendencia=?, TX_Descricao=? ");
        buff.append("WHERE OID_Ocorrencia_Cliente=?");
        try {
            PreparedStatement pstmt = conn.prepareStatement(buff.toString());
    ...
    public void delete() throws Exception {
        ...
        StringBuffer buff = new StringBuffer();
        buff.append("DELETE FROM Ocorrencias_Clientes ");
        buff.append("WHERE OID_Ocorrencia_Cliente=?");
        try {
            PreparedStatement pstmt = conn.prepareStatement(buff.toString());
            pstmt.setInt(1, getOID());
    ...
    public static final Ocorrencia_ClienteBean getByOID(int oid) throws Exception {
        Connection conn = null;
        try {
            conn = OracleConnection2.getWEB();
            conn.setAutoCommit(false);
        ...
        Ocorrencia_ClienteBean p = new Ocorrencia_ClienteBean();
        try {
            StringBuffer buff = new StringBuffer();
            buff.append(" SELECT Ocorrencias_Clientes.OID_Ocorrencia_Cliente, " + 
                        "Ocorrencias_Clientes.OID_Tipo_Ocorrencia, " + 
                        "Ocorrencias_Clientes.OID_Pessoa, " + 
                        "NM_Contato, DT_Ocorrencia_Cliente, " + 
                        "HR_Ocorrencia_Cliente, " + 
                        "DM_Gera_Pendencia, " + 
                        "DT_Final_Pendencia, " + 
                        "TX_Descricao, " + 
                        "Ocorrencias_Clientes.Dt_Stamp, " + 
                        "Ocorrencias_Clientes.Usuario_Stamp, " + 
                        "Ocorrencias_Clientes.Dm_Stamp, " + 
                        "Pessoas.NM_Razao_Social, " + 
                        "Tipos_Ocorrencias.NM_Tipo_Ocorrencia, " + 
                        "Tipos_Ocorrencias.CD_Tipo_Ocorrencia, " + 
                        "Pessoas.NR_CNPJ_CPF ");
            buff.append(" FROM Ocorrencias_Clientes, Pessoas, Tipos_Ocorrencias ");
            buff.append(" WHERE Ocorrencias_Clientes.OID_Tipo_Ocorrencia = Tipos_Ocorrencias.OID_Tipo_Ocorrencia ");
            buff.append(" AND Ocorrencias_Clientes.OID_Pessoa = Pessoas.OID_Pessoa ");
            buff.append(" AND Ocorrencias_Clientes.OID_Ocorrencia_Cliente =");
            buff.append(oid);
            buff.append(" ORDER BY Ocorrencias_Clientes.OID_Ocorrencia_Cliente  ");
            ...
            while (cursor.next()) {
                ...
                p.setDT_Ocorrencia_Cliente(cursor.getString(5));
                p.setHR_Ocorrencia_Cliente(cursor.getString(6));
    ...
    public static final List getAll() throws Exception {
        ...
        List Ocorrencia_Clientes_Lista = new ArrayList();
        try {
            StringBuffer buff = new StringBuffer();
            buff.append("SELECT Ocorrencias_Clientes.OID_Ocorrencia_Cliente, " + 
                        "Ocorrencias_Clientes.OID_Tipo_Ocorrencia, " + 
                        ...
                        "Pessoas.NR_CNPJ_CPF ");
            buff.append("FROM Ocorrencias_Clientes, Pessoas, Tipos_Ocorrencias ");
            buff.append("WHERE Ocorrencias_Clientes.OID_Tipo_Ocorrencia = Tipos_Ocorrencias.OID_Tipo_Ocorrencia " + "AND Ocorrencias_Clientes.OID_Pessoa = Pessoas.OID_Pessoa ");
            buff.append(" ORDER BY Ocorrencias_Clientes.OID_Ocorrencia_Cliente  ");
            ...
            while (cursor.next()) {
                ...
                p.setCD_Tipo_Ocorrencia(cursor.getString(15));
                p.setNR_CNPJ_CPF(cursor.getString(16));
                Ocorrencia_Clientes_Lista.add(p);
            }
            cursor.close();
            stmt.close();
            conn.close();
        ...
        return Ocorrencia_Clientes_Lista;
    }
    ...
    public static final List getByNR_CNPJ_CPF(String NR_CNPJ_CPF) throws Exception {
        ...
        try {
            ...
            buff.append("SELECT Ocorrencias_Clientes.OID_Ocorrencia_Cliente, " + 
                        ...
                        "Pessoas.NR_CNPJ_CPF ");
            buff.append("FROM Ocorrencias_Clientes, Pessoas, Tipos_Ocorrencias ");
            buff.append("WHERE Ocorrencias_Clientes.OID_Pessoa = Pessoas.OID_Pessoa " + "AND Ocorrencias_Clientes.OID_Tipo_Ocorrencia = Tipos_Ocorrencias.OID_Tipo_Ocorrencia "
    ...
    public static final List getByOidPessoa(String oidPessoa) throws Exception {
        ...
        try {
            ...
            buff.append("FROM Ocorrencias_Clientes, Pessoas, Tipos_Ocorrencias ");
            buff.append("WHERE Ocorrencias_Clientes.OID_Pessoa = Pessoas.OID_Pessoa " + "AND Ocorrencias_Clientes.OID_Tipo_Ocorrencia = Tipos_Ocorrencias.OID_Tipo_Ocorrencia "
                    + "AND Pessoas.oid_pessoa = '" + oidPessoa + "' " + "ORDER BY Ocorrencias_Clientes.OID_Ocorrencia_Cliente");
