    ...
    static public String corrigeString(String nome){
      ...
      //  // System.out.println("  I  ->> " + i+ " charac " + caracter + "S-> " + s + " valido " + String.valueOf(string_valida.charAt(s)) );
          ...
          if (s >= 999) nome_real = nome_real + caracter;
            ...
            caracter_troca = " ";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "A";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "a";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "a";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "A";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "a";
            ...
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "e";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "I";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "i";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "O";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "o";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "U";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "u";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "C";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "C";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "U";
            if (String.valueOf (caracter).equals ("�")) caracter_troca = "u";
            if (String.valueOf (caracter).equals ("&")) caracter_troca = "e";
