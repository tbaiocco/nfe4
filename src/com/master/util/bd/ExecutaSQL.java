...
public class ExecutaSQL {
    ...
    public ResultSet executarConsulta(String sql) throws Excecoes {
        ...
        ResultSet rs = null;
        if (conexao == null)
            throw new Excecoes("Conex�o n�o est� ativa!", this.getClass().getName(), "executarConsulta");
    ...
    public int executarUpdate(String sql) throws SQLException, Excecoes {
        ...
        if (conexao == null)
            throw new Excecoes("Conex�o n�o est� ativa!", this.getClass().getName(), "executarUpdate");
        try {
            st = conexao.createStatement();
