...
public class Fin006Bean
  ...
  public void geraRelatorioContas (HttpServletRequest request , HttpServletResponse response) throws Excecoes {
    ...
    listContasRel = this.Conta_Lista (request); // Chama o m�todo que retorna a lista

    ed.setLista (listContasRel); // Joga a lista de contas no ed para enviar pro relat�rio
    ed.setResponse (response);
    ed.setNomeRelatorio ("Contas_Estrutural"); // Seta o nome do relat�rio
  }
