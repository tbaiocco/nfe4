...
public class ctb001Bean {
  ...
  public void inclui(HttpServletRequest request)throws Excecoes{
	...
	if((oid_NF != null) && (!oid_NF.equals("")) && (!oid_NF.equals("null")))
      ...
      oid_NF = request.getParameter("oid_Lote_Posto");
      if((oid_NF != null) && (!oid_NF.equals("")) && (!oid_NF.equals("null")))
...
//  public ArrayList GeraEDI_Faturamento(HttpServletRequest request)throws Excecoes{
//
...
//
//    return new DuplicataRN().GeraEDI_Faturamento(ed);
//
//  }
