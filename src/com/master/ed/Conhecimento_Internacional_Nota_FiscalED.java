...
public class Conhecimento_Internacional_Nota_FiscalED extends MasterED{

  private String OID_Nota_Fiscal;
  private String DT_Conhecimento_Internacional_Nota_Fiscal;
  private String HR_Conhecimento_Internacional_Nota_Fiscal;
  ...
  private String OID_Conhecimento_Internacional_Nota_Fiscal;
  ...
  public void setOID_Conhecimento_Internacional_Nota_Fiscal(String OID_Conhecimento_Internacional_Nota_Fiscal) {
    this.OID_Conhecimento_Internacional_Nota_Fiscal = OID_Conhecimento_Internacional_Nota_Fiscal;
  }
  public String getOID_Conhecimento_Internacional_Nota_Fiscal() {
    return OID_Conhecimento_Internacional_Nota_Fiscal;
  }
  public void setDT_Conhecimento_Internacional_Nota_Fiscal(String DT_Conhecimento_Internacional_Nota_Fiscal) {
    this.DT_Conhecimento_Internacional_Nota_Fiscal = DT_Conhecimento_Internacional_Nota_Fiscal;
  }
  public String getDT_Conhecimento_Internacional_Nota_Fiscal() {
    return DT_Conhecimento_Internacional_Nota_Fiscal;
  }
  public void setHR_Conhecimento_Internacional_Nota_Fiscal(String HR_Conhecimento_Internacional_Nota_Fiscal) {
    this.HR_Conhecimento_Internacional_Nota_Fiscal = HR_Conhecimento_Internacional_Nota_Fiscal;
  }
  public String getHR_Conhecimento_Internacional_Nota_Fiscal() {
    return HR_Conhecimento_Internacional_Nota_Fiscal;
  }
  ...
  public String getDM_Exportacao() {
	...
	public void setDM_Tipo_Conhecimento(String tipo_Conhecimento) {
	    DM_Tipo_Conhecimento = tipo_Conhecimento;
	}
...
public void setNR_Cubagem(double cubagem) {
    NR_Cubagem = cubagem;
}
public double getNR_Cubagem_Total() {
    return NR_Cubagem_Total;
}
public void setNR_Cubagem_Total(double cubagem_Total) {
    NR_Cubagem_Total = cubagem_Total;
}
public String getNR_Lote() {
    return NR_Lote;
}
public void setNR_Lote(String lote) {
    NR_Lote = lote;
}
