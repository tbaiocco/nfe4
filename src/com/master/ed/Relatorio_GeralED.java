...
public class Relatorio_GeralED extends RelatorioBaseED {
    ...
    public Relatorio_GeralED() {
        super();
    }

    public Relatorio_GeralED(HttpServletResponse response, String nomeRelatorio) {
